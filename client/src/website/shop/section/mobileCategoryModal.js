...
const DRIVE_TRAINS=['Front-Wheel Drive','AWD', '4 Front-Wheel Drive','Rigt-Wheel Drive']

const CYLINDERS=['4','Boxer (4 cyl.)','Boxer (6 cyl)', 'Flat-six','Rotary','3Cyl','5Cyl','2Cyl','V12','V10','VR6','I4','V8','V6','V4','I6','I5','H4','I3']


const MobileCategoryModal = ({className, closeModal,filterList, applyFilter, setfilterList, reset}) => {
    ...
    <div className='flex justify-between items-start'>
      <p className='text-gray-700 text-2xl font-semibold'>Select Filters</p>
        <div className='absolute right-10 flex space-x-3'>          
          <AiOutlineClose size={24}   onClick={()=>closeModal()} className="  hover:text-secondary opacity-70"/>
        </div>
