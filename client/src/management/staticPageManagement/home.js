...
import {addAndUpdateHome, getHome} from "../../store/features/webcontent/webContentService"
...
function Home() {
                ...
                <div className="mt-1 mb-1">
                  <div>
                    <textarea
                      ...
                      value={bannerDetails.description||homeDetails?.section1_banner?.description}
        ...
        dispatch(uploadMedia(formData, image=>{
          if(image.data && image.data.url){
           ...
           section1_banner.image = image.data.url
            ...
            dispatch(addAndUpdateHome({section1_banner}, res=>{
              console.log("res----------",res)
            } ))
          }
        }))
  ...
  const submitSection5Images=()=>{
    dispatch(addAndUpdateHome({section5:{image:justUploadedImages}},(res)=>{
      console.log("res========",res)
      handleDeleteAll()
    }))
      ...
      <Accordion>
          ...
          <AccordionItemHeading>
            <AccordionItemButton>
              <div className="absolute -mt-5 ml-5 w-[55vw] flex items-center px-5 md:pr-0  justify-between">
                ...
                <button onClick={()=>submitBanner()} className="bg-gray-700 text-xs  text-white px-4 py-1 rounded-md">
                  Save
                </button>
              </div>
            </AccordionItemButton>
        ...
        <AccordionItem>
          <AccordionItemHeading>
            <AccordionItemButton>
              <div className="absolute -mt-16 ml-5 w-[55vw] flex px-5 md:pr-0 h-[100px] items-center justify-between">
                <p className="text-sm w-[50%] md:text-base">Section 2 - How It works Section</p>
          ...
          <AccordionItemPanel>
            ...
            <Form1 data={section2[0]} setimageFile={setSC1_imageFile} setData={val=>handleSection2Change(val,0 )} idkey={"card1"} />

            <p className="font-semibold text-gray-800 mb-5">Card 2</p>
            <Form1 data={section2[1]} setimageFile={setSC2_imageFile}  setData={val=>handleSection2Change(val,1 )} idkey={"card2"} />

            <p className="font-semibold text-gray-800 mb-5">Card 3</p>
            <Form1 data={section2[2]} setimageFile={setSC3_imageFile} setData={val=>handleSection2Change(val,2 )} idkey={"card3"} />
        ...
        <AccordionItem>
          ...
          <AccordionItemPanel>
          <Form1 data={section3} setimageFile={setS3_imageFile} setData={val=>setsection3(val)} idkey={"section3"}/>
        ...
        <AccordionItem>
          <AccordionItemHeading>
            ...
            <div className="absolute -mt-16 ml-5 w-[55vw] flex px-5 md:pr-0 h-[100px] items-center justify-between">
                ...
                <button onClick={()=>submitSection4()} className="bg-gray-700 text-xs text-white px-4 py-1 rounded-md">
                  Save
                </button>
              </div>
            </AccordionItemButton>
        ...
        <AccordionItem>
          <AccordionItemHeading>
            ...
            <div className="absolute -mt-16 ml-5 w-[55vw] flex px-5 md:pr-0 h-[100px] items-center justify-between">
                ...
                <button onClick={()=>submitSection5()} className="bg-gray-700 text-xs text-white px-4 py-1 rounded-md">
                  Save
                </button>
              </div>
            </AccordionItemButton>
  ...
  ease-in-out px-4 h-[40px] flex items-center justify-center`}
      ...
      <div className='flex space-x-4 mb-10'>
        ...
        {!!section5.image && section5.image.map((item, index) => (
          <div className='h-28  overflow-hidden  w-40'>
            <button
              className="text-black z-10 absolute m-[5px]"
